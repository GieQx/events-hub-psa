...
import { adaptAgendaData, adaptPartnerData, adaptTopicData, adaptResourceData } from "@/utils/cmsAdapters";
...
const EventPage = () => {
  ...
  const cmsAgenda = cmsService.agenda.getByEventId(eventId || "");
  const cmsPartners = cmsService.partners.getByEventId(eventId || "");
  const cmsTopics = cmsService.topics.getByEventId(eventId || "");
  const cmsResources = cmsService.resources.getByEventId(eventId || "");
  
  // Convert CMS data to component data formats
  const agenda = adaptAgendaData(cmsAgenda);
  const partners = adaptPartnerData(cmsPartners);
  const topics = adaptTopicData(cmsTopics);
  const resources = adaptResourceData(cmsResources);
    ...
    <div className="min-h-screen">
      ...
      <section id="hero" className="relative min-h-screen overflow-hidden pt-16">
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100vh-4rem)] max-w-7xl flex-col items-center justify-center px-6 py-16 text-center text-white">
          <ScrollSection>
            <div className="mb-4 inline-block rounded-full px-4 py-1 text-sm font-medium" 
                 style={{ backgroundColor: `var(--${getEventColor()})` }}>
      ...
      <section className="py-3 text-white" style={{ backgroundColor: `var(--${getEventColor()})` }}>
        <MarqueeSection 
      ...
      <main className="bg-gray-50 pb-20 dark:bg-gray-900">
        ...
        <section id="faqs" className="scroll-mt-20 bg-white py-16 dark:bg-gray-800 relative">
          <ParticleBackground 
            color={getParticleColor()} 
            particleCount={75}
            className="opacity-10" 
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#hero" className="hover:text-opacity-80" style={{ color: `var(--${getEventColor()})` }}>Home</a></li>
                <li><a href="#about" className="hover:text-opacity-80" style={{ color: `var(--${getEventColor()})` }}>About</a></li>
                <li><a href="#speakers" className="hover:text-opacity-80" style={{ color: `var(--${getEventColor()})` }}>Speakers</a></li>
                <li><a href="#agenda" className="hover:text-opacity-80" style={{ color: `var(--${getEventColor()})` }}>Agenda</a></li>
                <li><a href="#topics" className="hover:text-opacity-80" style={{ color: `var(--${getEventColor()})` }}>Topics</a></li>
                <li><a href="#guide" className="hover:text-opacity-80" style={{ color: `var(--${getEventColor()})` }}>Attendee Guide</a></li>
                <li><a href="#challenge" className="hover:text-opacity-80" style={{ color: `var(--${getEventColor()})` }}>Convention Challenge</a></li>
                <li><a href="#resources" className="hover:text-opacity-80" style={{ color: `var(--${getEventColor()})` }}>Resources</a></li>
                <li><a href="#faqs" className="hover:text-opacity-80" style={{ color: `var(--${getEventColor()})` }}>FAQs</a></li>
              </ul>
            </div>
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-white hover:text-opacity-80" style={{ color: `var(--${getEventColor()})` }}>
